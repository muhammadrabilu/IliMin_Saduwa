...
import com.ayyukana.iliminsaduwa.Activity.YoutubePlayerActivity
...
class YoutubeAdapter(val respond: Respond, val mOnItemClickListener: OnItemClickListener) :
    ...
    override fun getItemCount(): Int {
     ...
     inner class myViewHolder(itemView: View, val onItemClickListener: OnItemClickListener,  var snippet: Snippet? = null) : RecyclerView.ViewHolder(itemView),
